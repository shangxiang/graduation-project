...
def pos_neg_test():
    ...
    word2vec_path = '.\\out\\trained_word2vec.model'
...
if __name__ == '__main__':
    ...
    THUCNews_path = 'D:\\bs\\chinesecorpus\\THUCNews'
    # 读取所有文件列表
    files_list, label_list = files_processing.gen_files_labels(THUCNews_path)
    max_sentence_length = 300
    word2vec_path = "D:\\pypro\\bs\\model\\size70.model"
    # 获得标签集合，并保存在本地
    # labels_set=['星座','财经','教育']
    # labels_set = files_processing.get_labels_set(label_list)
    ...
    # 将数据划分为train val数据集
    print(len(files_list),len(label_list))
    print(files_list,label_list)
